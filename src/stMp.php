...
class stMp extends \standard\standard{
  ...
  */
   ...
   * @return (string) $str
  */
  public static function _stripSpace(string $str): string{
  ...
  */
   ...
   * @return (string)
  */
  public static function _removeSlashes(string $str): string{
   ...
   * @return (string)
  */
  public static function _removeDoubleSlashes(string $str): string{
    $str = self::removeDoubleSlashes($str);
    return $str;
  }
   ...
   * @return (string)
  */
  public static function _reduceMultiples(string $str, $char = ',', $trim = false){
    $str = self::reduceMultiples($str);
    return $str;
  }
